...
describe('validDomains', () => {
  describe('testing main validDomain flow', () => {
  ...
  describe('testing fallback validDomain flow with fetch succeeding and no json object', () => {
    let utils: Utils = new Utils();
    beforeEach(() => {
      // Set a mock window for testing
      utils = new Utils();
  ...
  describe('testing fallback validDomain flow with fetch error', () => {
    let utils: Utils = new Utils();
    beforeEach(() => {
      // Set a mock window for testing
      utils = new Utils();
