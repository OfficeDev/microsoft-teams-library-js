...
import { ReturnFocusType, TabInstance } from './interfaces';
import {
...
/**
 * @deprecated
 * As of TeamsJS v2.0.0, please use {@link pages.returnFocus pages.returnFocus(navigateForward?: boolean, returnFocusType?: ReturnFocusType): void} instead.
 *
