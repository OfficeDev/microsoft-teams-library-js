...
class ConfigurableTabInstanceResponseHandler extends ResponseHandler<ConfigurableTabInstance, ConfigurableTabInstance> {
...
class HostEntityTabInstancesResponseHandler extends ResponseHandler<HostEntityTabInstances, HostEntityTabInstances> {
 ...
 */
export function rename(tab: ConfigurableTabInstance, hostEntityIds: HostEntityIds): Promise<ConfigurableTabInstance> {
  ensureInitialized(runtime);
...
export function isSupported(): boolean {
  return ensureInitialized(runtime) && isHostEntitySupported() && runtime.supports.hostEntity?.tab ? true : false;
}
