...
export const enum ApiName {
  ...
  HostEntity_Tab_addAndConfigureApp = 'associatedApps.tab.addAndConfigureApp',
  HostEntity_Tab_reconfigure = 'associatedApps.tab.reconfigure',
  HostEntity_Tab_rename = 'associatedApps.tab.rename',
  HostEntity_Tab_remove = 'associatedApps.tab.remove',
  HostEntity_Tab_getTabs = 'associatedApps.tab.getTabs',
