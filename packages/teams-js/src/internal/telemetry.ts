...
export enum ApiName {
  ...
  Menu_HandleActionMenuItemPress = 'menu.handleActionMenuItemPress',
  Menu_HandleNavBarMenuItemPress = 'menu.handleNavBarMenuItemPress',
  Menu_HandleViewConfigItemPress = 'menu.handleViewConfigItemPress',
  Menu_RegisterActionMenuItemPressHandler = 'menu.registerActionMenuItemPressHandler',
  Menu_RegisterNavBarMenuItemPressHandler = 'menu.registerNavBarMenuItemPressHandler',
  Menu_RegisterSetModuleViewHandler = 'menu.registerSetModuleViewHandler',
  Menu_SetUpViews = 'menu.setUpViews',
  Menu_SetNavBarMenu = 'menu.setNavBarMenu',
  Menu_ShowActionMenu = 'menu.showActionMenu',
