...
export enum ApiName {
  ...
  Dialog_Url_SendMessageToParentFromDialog = 'dialog.url.parentCommunication.sendMessageToParentFromDialog',
  Dialog_Url_SendMessageToDialog = 'dialog.url.parentCommunication.sendMessageToDialog',
