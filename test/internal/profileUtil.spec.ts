...
describe('validateShowProfileRequest', () => {
  ...
  it('should return false if persona property is missing', () => {
    const missingPersona = { ...validInput, persona: undefined } as any;
    expect(validateShowProfileRequest(missingPersona)).toBeFalsy();
  });

  it('should return false if persona display name is not a string', () => {
    const invalidDisplayName = { ...validInput, persona: { ...validInput.persona, displayName: 1 } } as any;
  ...
  it('should return false if persona identifiers property is missing', () => {
    const missingIdentifiers = { ...validInput, persona: { ...validInput.persona, identifiers: undefined } } as any;
  ...
  it('should return false if persona identifiers property is not an object', () => {
    const invalidIdentifiers = { ...validInput, persona: { ...validInput.persona, identifiers: 1 } } as any;
  ...
  it('should return false if targetBoundingRect property is missing', () => {
    const missingTargetBoundingRect = { ...validInput, targetElementBoundingRect: undefined } as any;
  ...
  it('should return false if targetBoundingRect property is not an object', () => {
    const invalidTargetBoundingRect = { ...validInput, targetElementBoundingRect: 1 } as any;
  ...
  it('should return false if triggerType property is missing', () => {
    const missingTriggerType = { ...validInput, triggerType: undefined } as any;
  ...
  it('should return false if triggerType property is not a string', () => {
    const invalidTriggerType = { ...validInput, triggerType: 1 } as any;
  ...
  it('should return false if persona type property is not a string', () => {
    const invalidPersonaType = {
      ...
      persona: {
        ...validInput.persona,
        identifiers: { ...validInput.persona.identifiers, PersonaType: 1 },
      },
    } as any;
  ...
  it('should return false if any identifiers are invalid', () => {
    const invalidAadObjectId = {
      ...
      persona: {
        ...validInput.persona,
        identifiers: { AadObjectId: 1, PersonaType: validInput.persona.identifiers.PersonaType },
      },
    } as any;
    ...
    const invalidSmtp = {
      ...
      persona: {
        ...validInput.persona,
        identifiers: { Smtp: 1, PersonaType: validInput.persona.identifiers.PersonaType },
      },
    } as any;
    ...
    const invalidTeamsMri = {
      ...
      persona: {
        ...validInput.persona,
        identifiers: { TeamsMri: 1, PersonaType: validInput.persona.identifiers.PersonaType },
      },
    } as any;
    ...
    const invalidUpn = {
      ...
      persona: {
        ...validInput.persona,
        identifiers: { Upn: 1, PersonaType: validInput.persona.identifiers.PersonaType },
      },
    } as any;
