...
/**
    * @hidden
    */
export function createEffectParameterChangeCallback(callback: VideoEffectCallBack, viddoPerformanceMonitor: VideoPerformanceMonitor): (effectId: string | undefined, effectParam?: string) => void;
