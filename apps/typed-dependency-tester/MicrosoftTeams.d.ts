...
/**
    ...
    * Limited to Microsoft-internal use
    */
export function initializeCommunication(validMessageOrigins: string[] | undefined, apiVersionTag: string): Promise<InitializeResponse>;
/**
    * @internal
    * Limited to Microsoft-internal use
    */
...
/**
    ...
    * Limited to Microsoft-internal use
    */
export function sendAndHandleStatusAndReasonWithDefaultError(apiVersionTag: string, actionName: string, defaultError: string, ...args: any[]): Promise<void>;
/**
    * @deprecated This function is deprecated and will be removed in a future release. Please use {@link callFunctionInHostAndHandleResponse} or {@link callFunctionInHost} instead.
    * @hidden
...
/**
    ...
    * Limited to Microsoft-internal use
    */
export function sendMessageToParentAsync<T>(apiVersionTag: string, actionName: string, args?: any[] | undefined): Promise<T>;
...
/**
    ...
    * @throws An Error containing the SdkError information ({@link SdkError.errorCode} and {@link SdkError.message}) if the host returns an SdkError, or an Error if the response from the host is an unexpected format.
    */
export function callFunctionInHost(functionName: string, args: (SimpleType | ISerializable)[], apiVersionTag: string, isResponseAReportableError?: (response: unknown) => response is {
        errorCode: number | string;
        message?: string;
}): Promise<void>;
/**
    ...
    * Limited to Microsoft-internal use
    */
export function requestPortFromParentWithVersion(apiVersionTag: string, actionName: string, args?: any[] | undefined): Promise<MessagePort>;
/**
    * @deprecated This function is deprecated and will be removed in a future release. Please use {@link callFunctionInHostAndHandleResponse} or {@link callFunctionInHost} instead.
    * @internal
    * Limited to Microsoft-internal use
...
/**
    ...
    * Limited to Microsoft-internal use
    */
export function sendMessageToParent(apiVersionTag: string, actionName: string, args: any[] | undefined, callback?: Function): void;
/**
    * @internal
    * Limited to Microsoft-internal use
    */
...
/**
    ...
    * Limited to Microsoft-internal use
    */
export function tryPolyfillWithNestedAppAuthBridge(clientSupportedSDKVersion: string, window: Window | null, handlers: NestedAppAuthBridgeHandlers): void;
export {};
