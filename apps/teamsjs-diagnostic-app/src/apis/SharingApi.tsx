...
export const sharing_CheckSharingCapability = async (): Promise<void> => {
    ...
    try {
      ...
      if (result) {
        ...
        console.log('Sharing module is not supported. Sharing is not supported on TM365 Web, Outlook Web, M365 Desktop, Outlook Desktop, M365 Mobile, or Outlook Mobile.');
