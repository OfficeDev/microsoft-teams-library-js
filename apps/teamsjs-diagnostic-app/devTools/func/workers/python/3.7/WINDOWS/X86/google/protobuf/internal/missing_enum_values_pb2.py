...
_TESTENUMVALUES = DESCRIPTOR.message_types_by_name['TestEnumValues']
_TESTMISSINGENUMVALUES = DESCRIPTOR.message_types_by_name['TestMissingEnumValues']
_JUSTSTRING = DESCRIPTOR.message_types_by_name['JustString']
_TESTENUMVALUES_NESTEDENUM = _TESTENUMVALUES.enum_types_by_name['NestedEnum']
_TESTMISSINGENUMVALUES_NESTEDENUM = _TESTMISSINGENUMVALUES.enum_types_by_name['NestedEnum']
