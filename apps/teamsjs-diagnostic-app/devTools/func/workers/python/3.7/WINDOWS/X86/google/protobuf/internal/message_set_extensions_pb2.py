...
message_set_extension3 = DESCRIPTOR.extensions_by_name['message_set_extension3']
...
_TESTMESSAGESETEXTENSION3 = DESCRIPTOR.message_types_by_name['TestMessageSetExtension3']
