...
* `registerChangeSettingsHandler` has been renamed to `registerChangeConfigHandler` and moved to `pages.config`, while teams-js has renamed this function to `registerEnterSettingsHandler`.
