...
You can access [these files on unpkg](https://statics.teams.cdn.office.net/sdk/v1.8.0/js/MicrosoftTeams.min.js), download them, or point your package manager to them.
