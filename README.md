...
You can access [these files on unpkg](https://unpkg.com/@microsoft/teams-js@1.3.0/dist/MicrosoftTeams.min.js), download them, or point your package manager to them.
...
<script src="https://unpkg.com/@microsoft/teams-js@1.3.0/dist/MicrosoftTeams.min.js" integrity="sha384-8UKsjgLJgOHe185w6tQQLyVnk0L3TnM6HXQpGlVcYAZcbFqwdIYTuWCKfcCjWcOg" crossorigin="anonymous"></script>

<!-- Microsoft Teams JavaScript API (via npm) -->
<script src="node_modules/@microsoft/teams-js@1.3.0/dist/MicrosoftTeams.min.js"></script>
