...
export namespace appNotification {
   ...
   * The notificationActionUrl to be stored in this data structure would b serialized from a URL type to a string type for efficient transfer of data across the iframe
   */
