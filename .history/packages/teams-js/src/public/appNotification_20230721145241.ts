...
export namespace appNotification {
   ...
   * @returns a NotificationDisplay object that has been serizialed and would be passed across to the hubsdk; the notificationActionUrl has been converted from a URl type to a string type
   *  to allow for efficient transmission of data across the iframe
   */
