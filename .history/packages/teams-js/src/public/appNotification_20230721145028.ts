...
export namespace appNotification {
   ...
   * @returns a NotificationDisplay object that has been serizialed and wou; the notificationActionUrl has been converted from a URl type to a string type to allow for efficient transmission of data across the iframe
   */
